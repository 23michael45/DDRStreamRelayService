...
//{
//	if (mLocalAudioThread.joinable())
//		mLocalAudioThread.join();
//	EndSubThreads();
...
//}
//
//void AudioTranscode::LocalAudioThread()
//{
//	zWalleAudio s_audio;
//	std::shared_ptr<DDRLNN::LNNNodeGroupInterface> LNGPush;
//	LNGPush = DDRLNN::CreateNodeGroup();
...
//
//	/**********************Local Audio Thread 2018.11.19***********************/
//	mLocalAudioThread = std::thread(&AudioTranscode::LocalAudioThread, this);
//	/**********************Local Audio Thread 2018.11.19***********************/
//
